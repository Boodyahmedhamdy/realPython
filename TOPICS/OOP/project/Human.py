...
class Human:
    ...
    def __init__(self):
        ...
        self.firstName: str = input('what is your first name: ').strip().capitalize()
        self.middleName: str = input('what is your middle name: ').strip().capitalize()
        self.lastName: str = input('what is your last name: ').strip().capitalize()

        self.profileImage = Image.open("images/defualtImage.jpg")

        self.phoneNumber: str = input('your phone number: ').strip()
        ...
        Human.ID += 1
        print(coloredText.mk_green(f'created user successfully,welcome {self.firstName} {self.middleName} {self.lastName}'))
